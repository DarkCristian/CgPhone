...
> **Estado actual:** `v0.3.2-rc.2`, prerelease Windows build #44 aún sin validación funcional manual; Linux conserva los binarios experimentales de RC1. No es una aprobación productiva.
...
La prerelease [v0.3.2-rc.2](https://github.com/DarkCristian/CgPhone/releases/tag/v0.3.2-rc.2) reúne:

- Windows: instalador EXE y portable ZIP exactos del build #44, pendientes de validación funcional manual.
- Linux: paquete .deb y archivo .tar.xz experimentales de RC1 sin cambios, para Debian 13 amd64. El tar.xz requiere dependencias del sistema.
- SBOM separados por plataforma, hashes SHA-256 y reportes con su alcance explícito.

Verificar cada archivo contra el [manifiesto combinado](https://github.com/DarkCristian/CgPhone/releases/download/v0.3.2-rc.2/SHA256SUMS.txt). Los hashes históricos de beta.38/39 sólo identifican sus archivos; Windows RC1 reutiliza exactamente los de beta.39.
