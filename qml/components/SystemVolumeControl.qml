...
Rectangle {
    ...
    component RoundStepButton: Button {
        ...
        contentItem: Text { text: stepButton.text; color: "#475569"; font.pixelSize: 14; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter }
        background: Rectangle { radius: 12; color: stepButton.down ? "#DCEBFF" : "#EFF6FF"; border.color: "#D4E4FA" }
    }
    ...
    component RoundSlider: Slider {
        ...
        background: Rectangle {
            ...
            width: control.availableWidth; height: 6; radius: 3; color: "#DFE7F1"
            Rectangle { width: control.visualPosition * parent.width; height: parent.height; radius: 3; color: "#60A5FA" }
        }
        handle: Rectangle {
            x: control.leftPadding + control.visualPosition * (control.availableWidth - width)
            y: control.topPadding + control.availableHeight / 2 - height / 2
            width: 16; height: 16; radius: 8; color: "#FFFFFF"; border.width: 3; border.color: "#2563EB"
        }
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Label { text: systemAudio.outputVolume + "%"; color: "#64748B"; font.pixelSize: 9; Layout.preferredWidth: 28 }
        }
        RowLayout {
            Layout.fillWidth: true; spacing: 5
            Button {
            ...
            Label { text: systemAudio.microphoneVolume + "%"; color: "#64748B"; font.pixelSize: 9; Layout.preferredWidth: 28 }
        }
    }
}
