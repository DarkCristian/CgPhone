...
|---|---|---|---|
| [v0.3.2-rc.1](https://github.com/DarkCristian/CgPhone/releases/tag/v0.3.2-rc.1) | Windows x64 / Linux amd64 | Windows RC build #39 validado; Linux experimental Debian 13 | Reportes aceptados; sin aprobación productiva |
| v0.3.2-beta.38 ([workflow #38](https://github.com/DarkCristian/CgPhone/actions/runs/34388740867)) | Windows x64 | Referencia histórica validada en Windows | Sí, durante la etapa beta |
