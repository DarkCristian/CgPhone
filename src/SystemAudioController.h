...
class SystemAudioController final : public QObject {
    ...
    Q_PROPERTY(bool microphoneMuted READ microphoneMuted NOTIFY microphoneMutedChanged)
...
public:
    ...
    Q_INVOKABLE void toggleMicrophoneMute();
...
private:
    ...
    bool queryMute(bool *ok) const;
    bool applyMute(bool muted) const;
